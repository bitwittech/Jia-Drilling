...
<head>
    <meta charset="utf-8">
    <title> Jia Drilling - JSP-10 PORTABLE SEISMIC SHOT HOLE DRILLING RIG</title>
    <!-- Stylesheets -->
    ...
    <div class="page-wrapper">
            ...
            <div class="auto-container">
                <div class="p_relative text-center">
                    <h1 class="c_light mb_10 fw_black fs_45 wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                        JSP-10 PORTABLE SEISMIC SHOT HOLE DRILLING RIG</h1>
                    <ul class="list-none fs_18 d-flex justify-content-center c_light wow fadeInLeft"
                        ...
                        <li>Products</li>
                        <li class="ml_10 mr_10">/</li>
                        <li>JSP-10 PORTABLE SEISMIC SHOT HOLE DRILLING RIG</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="pt_120 pb_90">
            <div class="auto-container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb_30"><img src="assets/newImages/Blast Hole Drilling Rig/JSP-10.jpg" alt=""></div>
                    </div>
                    <div class="col-lg-6 ps-lg-5">
                        ...
                        <h2 class="fw_black fs_30 mb_20">JSP-10 PORTABLE SEISMIC SHOT HOLE DRILLING RIG</h2>
                        <p class="mb_15 fs_16">The JSP-10 is a Portable Seismic Shot Hole Drilling Rig especially
                            designed for single pass seismic shot hole drilling up to 262 feet (80 Meters) for a drill
                            diameter of 3½" to 4⅛" (89 mm to 105 mm). It is capable of rotary drilling with 2700 Kg
                            pull-up force and 0 − 60 RPM or may be used with down-the-hole drills when equipped with a
                            high-pressure air compressor. The same drilling rig can also be utilized for blast hole
                            drilling and shallow domestic water well drilling also.
                ...
                <thead>
                    <tr>
                        <th colspan="2" class="text-center" style="font-size: 16px;">
                            TECHNICAL SPECIFICATIONS - JSP-10 PORTABLE SEISMIC SHOT HOLE DRILLING RIG
                        </th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <td>PRIME MOVER</td>
                        <td>Power required for the rig hydraulic is drawn from the Hydraulic Power Pack attached with
                            engine or tractor engine through the output PTO Shaft, Suitable Tractor 45 Hp and above</td>
                    </tr>
                    <tr>
                        <td>WORK METHOD</td>
                        <td>DTH Drilling</td>
                    ...
                    <tr>
                        <td>MAST</td>
                        <td>5" Channel Structure Mast, Maximum Capacity − 8 Tons, Height − 2.75 Meter (9 Foot), Rod
                            Handling − 60", Centralized Opening − 7"</td>
                    </tr>
                    <tr>
                        <td>PULL UP SPEED</td>
                    ...
                    <tr>
                        <td>OTHER OPTIONS</td>
                        <td>The same mast can be mounted on a small truck for easy approach to difficult site
                            conditions. This can also be altered to drill horizontal bores up to 262 Foot</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Four Hydraulic Leveling Jacks for accurate leveling of drill point, each having a separate
                            lever</td>
                    </tr>
                </tbody>
            </table>
