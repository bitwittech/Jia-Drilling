...
<head>
    <meta charset="utf-8">
    <title> Jia Drilling - JWC-25 TROLLEY MOUNTED DTHR WATER WELL DRILLING RIG</title>
    <!-- Stylesheets -->
...
<body>
    ...
    <div class="page-wrapper">
            ...
            <div class="auto-container">
                <div class="p_relative text-center">
                    <h1 class="c_light mb_10 fw_black fs_45 wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                        JWC-25 TROLLEY MOUNTED DTHR WATER WELL DRILLING RIG</h1>
                    <ul class="list-none fs_18 d-flex justify-content-center c_light wow fadeInLeft"
                        ...
                        <li>Products</li>
                        <li class="ml_10 mr_10">/</li>
                        <li>JWC-25 TROLLEY MOUNTED DTHR WATER WELL DRILLING RIG</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="pt_120 pb_90">
            <div class="auto-container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb_30"><img src="assets/newImages/DTH/JWC-25.jpg" alt=""></div>
                    </div>
                    <div class="col-lg-6 ps-lg-5">
                        ...
                        <h2 class="fw_black fs_30 mb_20">JWC-25 TROLLEY MOUNTED DTHR WATER WELL DRILLING RIG</h2>
                        <p class="mb_15 fs_16">The JWC-25 is Trolley Mounted DTHR Water Well Drilling Rig especially designed for water well drilling up to 650 feet (200 Meters) for a drill diameter of 6 ½" (165 mm). It is also capable of Rotary drilling with 9 200 Kg pull force and 0 − 100 RPM or may be used with down the hole drills of 6 ½" when equipped with a high-pressure air compressor. The same rig can also be utilized for exploration and micro-piling work.
  ...
  <table summary="Summary Here" class="table table-bordered table-striped">
    <thead class="thead-dark">
      <tr>
        <th colspan="2" style="font-size:16px; text-align: center;">TECHNICAL SPECIFICATIONS - JWC-25 TROLLEY MOUNTED DTHR WATER WELL DRILLING RIG</th>
      </tr>
    </thead>
    <tbody>
      <tr>
