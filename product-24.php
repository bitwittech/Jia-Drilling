...
<head>
    <meta charset="utf-8">
    <title> Jia Drilling -  SOLID 60 TRUCK MOUNTED DTHR WATER WELL DRILLING RIG</title>
    <!-- Stylesheets -->
...
<body>
    ...
    <div class="page-wrapper">
            ...
            <div class="auto-container">
                <div class="p_relative text-center">
                    <h1 class="c_light mb_10 fw_black fs_45 wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                         SOLID 60 TRUCK MOUNTED DTHR WATER WELL DRILLING RIG</h1>
                    <ul class="list-none fs_18 d-flex justify-content-center c_light wow fadeInLeft"
                        ...
                        <li>Products</li>
                        <li class="ml_10 mr_10">/</li>
                        <li> SOLID 60 TRUCK MOUNTED DTHR WATER WELL DRILLING RIG</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="pt_120 pb_90">
            <div class="auto-container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb_30"><img src="assets/newImages/DTH/SOLID-60.jpg" alt=""></div>
                    </div>
  ...
  <table summary="Summary Here" class="table table-bordered table-striped">
    <thead class="thead-dark">
      <tr>
        <th colspan="2" style="font-size:16px; text-align: center;">TECHNICAL SPECIFICATIONS - SOLID 60 TRUCK MOUNTED DTHR WATER WELL DRILLING RIG</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td>DRILLING DEPTH</td>
        <td>6 ½" Ø − 12" Ø Bore Holes, 600 Meter (2000 Foot) by using 4 ½" Drill Rods<br>Odex Dia. − 5" to 8" − 1,500 foot depth</td>
      </tr>
      <tr>
        <td>PLATFORM</td>
      ...
      <tr>
        <td>PRIME MOVER</td>
        <td>Rig hydraulic system is powered from deck engine</td>
      </tr>
      <tr>
        <td>WORK METHOD</td>
      ...
      <tr>
        <td>MAST</td>
        <td>10" Channel Structure Mast, Height − 9 Meter (29.5 Foot), Rod Handling − 15 Foot / 20 Foot Rod, Rotary Head Travel − 7,940 mm, Centralized Opening − 16" (406 mm), 20 mm double wire rope</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>26,000 Kg / 57,320 lbs</td>
      </tr>
      <tr>
        <td>HYDRAULIC SYSTEM</td>
        <td>210 Kg/cm² (3,000 psi)<br>Oil Tank − 1,000 Liters, Oil Filters - SC²-100 - 04 no.<br>Double super system, Hydraulic Oil Cooler − Standard Fin Type 95 GPM</td>
      </tr>
      <tr>
        <td>REEVING RATIO</td>
