...
<head>
    <meta charset="utf-8">
    <title> Jia Drilling - JCT-200 TRACTOR MOUNTED DIAMOND CORE WIRE LINE DRILLING RIG</title>
    <!-- Stylesheets -->
    ...
    <div class="page-wrapper">
            ...
            <div class="auto-container">
                <div class="p_relative text-center">
                    <h1 class="c_light mb_10 fw_black fs_45 wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                        JCT-200 TRACTOR MOUNTED DIAMOND CORE WIRE LINE DRILLING RIG</h1>
                    <ul class="list-none fs_18 d-flex justify-content-center c_light wow fadeInLeft"
                        ...
                        <li>Products</li>
                        <li class="ml_10 mr_10">/</li>
                        <li>JCT-200 TRACTOR MOUNTED DIAMOND CORE WIRE LINE DRILLING RIG</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="pt_120 pb_90">
            <div class="auto-container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb_30"><img src="assets/newImages/Exploration Drilling Rig/JCT-200.png" alt=""></div>
                    </div>
                    <div class="col-lg-6 ps-lg-5">
                        ...
                        <h2 class="fw_black fs_30 mb_20">JCT-200 TRACTOR MOUNTED DIAMOND CORE WIRE LINE DRILLING RIG</h2>
                        <p class="mb_15 fs_16">The JCT - 200 is a Tractor Mounted Diamond Core Wire Line Drilling Rig especially designed for surface core drilling up to 656 feet (200 Meters) for an NQ Size. The high-speed top-head rotary head can do various HQ, PQ, and NQ drill sizes. It is also capable of Rotary drilling with 4700 Kg pull-up force and 150 - 1000 RPM. The rig is specially designed for surface exploration.
        ...
        <div class="container">
  <table class="table table-bordered table-striped" summary="Summary Here">
    <thead>
      <tr>
        <th colspan="2" class="text-center" style="font-size: 16px;">
          TECHNICAL SPECIFICATIONS - JCT-200 TRACTOR MOUNTED DIAMOND CORE WIRE LINE DRILLING RIG
        </th>
      </tr>
    </thead>
    <tbody>
      <tr>
        ...
        <td>PQ - 40 Meter, HQ - 100 Meter, NQ - 200 Meter</td>
      </tr>
      <tr>
        <td>DRILLING ANGLE</td>
        <td>45° TO 90°</td>
      </tr>
      <tr>
        <td>PRIME MOVER</td>
        <td>Rig hydraulic system is powered from the tractor engine through the output PTO Shaft. - Tractor Horse Power - 60 or above</td>
      </tr>
      <tr>
        <td>MAST</td>
        <td>6" Channel Structure Mast, Height - 5.5 Meter (18 Foot), Rod Handling - 120", Centralized Opening - 8"</td>
      </tr>
      <tr>
        <td>PULL UP SPEED</td>
        <td>21 Meter / Min (69 Foot/Min)</td>
      </tr>
      <tr>
        <td>PULL UP FORCE</td>
      ...
      <tr>
        ...
        <td>42 Meter / Min (137 Foot/Min)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>210 Kg/cm<sup>2</sup> (3,000 psi)<br>Oil Tank - 300 Liters, Oil Filters - SC<sup>2</sup>-75 - 02 no.<br>Variable Displacement Pump for Feed, Rotation and Winches - 01 No.<br>Fixed Displacement Pump for Water Pump - 01 No.<br>Tractor Oil Pump utilized for hydraulic oil cooler<br>Hydraulic oil cooler - 70 GPM</td>
      </tr>
      <tr>
        <td>FEED SYSTEM</td>
        <td>Hydraulic Cylinder with 1:1 Ratio</td>
      </tr>
      <tr>
        <td>ROTARY HEAD</td>
        <td>Maximum Torque 303 Kg-Meter (26,400 lbs-inch), OMT-315 Orbital Motor<br>Rotary Head Sliding Guide for wire line winch operation.</td>
      </tr>
      <tr>
        <td>ROTARY HEAD SPEED</td>
        <td>150 to 1000 rpm</td>
      </tr>
      <tr>
        <td>WATER PUMP</td>
        <td>117 LPM, 39 Kg/cm<sup>2</sup> Triplex Piston Pump driven by hydraulic motor</td>
      </tr>
      <tr>
        <td>FOOT CLAMP</td>
        <td>Mechanical Rod Clamp has gripping range of PQ, HQ and NQ Rods</td>
      </tr>
      <tr>
        <td>WINCH</td>
        <td>Main Winch - 3 Ton, Line Speed - 45 Meter/Min<br>Wire Line Winch - 0.5 Ton, Line Speed - 70 Meter/Min</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>Four Hydraulic Leveling Jack for accurate leveling of drill point having separate lever</td>
      </tr>
      <tr>
        <td>CONTROL PANEL</td>
