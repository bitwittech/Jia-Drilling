...
<head>
    <meta charset="utf-8">
    <title> Jia Drilling - JWP-10 PORTABLE DTH WATER WELL DRILLING RIG</title>
    <!-- Stylesheets -->
    ...
    <div class="page-wrapper">
            ...
            <div class="auto-container">
                <div class="p_relative text-center">
                    <h1 class="c_light mb_10 fw_black fs_45 wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                        JWP-10 PORTABLE DTH WATER WELL DRILLING RIG</h1>
                    <ul class="list-none fs_18 d-flex justify-content-center c_light wow fadeInLeft"
                        ...
                        <li>Products</li>
                        <li class="ml_10 mr_10">/</li>
                        <li>JWP-10 PORTABLE DTH WATER WELL DRILLING RIG</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="pt_120 pb_90">
            <div class="auto-container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb_30"><img src="assets/newImages/DTH/JWP-10.jpg" alt=""></div>
                    </div>
                    <div class="col-lg-6 ps-lg-5">
                        ...
                        <h2 class="fw_black fs_30 mb_20">JWP-10 PORTABLE DTH WATER WELL DRILLING RIG</h2>
                        <p class="mb_15 fs_16">The JWP-10 is a Portable Water Well Drilling Rig especially designed for DTH Water Well drilling up to 262 feet ( 80 Meters) for a drill diameter of 3½" to 4⅛" (89 mm to 105 mm). It is capable of rotary drilling with 2700 Kg pull-up force and 0 − 60 RPM or may be used with down-the-hole drills when equipped with a high-pressure air compressor. The same drilling rig can also be utilized for blast hole drilling and seismic shot hole drilling.
      ...
      <thead class="thead-dark">
        <tr>
          <th colspan="2" class="text-center" style="font-size:16px;">
            TECHNICAL SPECIFICATIONS - JWP-10 PORTABLE DTH WATER WELL DRILLING RIG
          </th>
        </tr>
      </thead>
      <tbody>
        <tr>
          ...
          <td>Maximum 4⅛" Bore Holes, 80 Meter (262 Foot) by using 2" / 2½" Drill Rods</td>
        </tr>
        <tr>
          <td>PRIME MOVER</td>
          <td>Power required for the rig hydraulic is drawn from the Hydraulic Power Pack attached with the engine or tractor engine through the output PTO Shaft, Suitable Tractor 45 Hp and above</td>
        </tr>
        <tr>
          <td>WORK METHOD</td>
          <td>DTH Drilling</td>
        ...
        <tr>
          ...
          <td>Four Hydraulic Leveling Jacks for accurate leveling drill point, each with a separate lever</td>
        </tr>
      </tbody>
    </table>
  </div>
