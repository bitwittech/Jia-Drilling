...
<head>
    <meta charset="utf-8">
    <title> Jia Drilling - Geo Exploration</title>
    <!-- Stylesheets -->
                            ...
                            <div
                                ...
                                <div>
                                    <img style="width : 300px;height:200px"
                                        src="./assets/newImages/Exploration Drilling Rig/JCC-300-2.png"
                                        alt="service_img" />
                                    <br>
                                    <br>
                                    <h4 class="fs_18 fw_normal c_dark4">JCC-300</span></h4>
                                    <div class="link mb_75"><a href="product-21.php"
                    ...
                    <div class="col-lg-4 ">
                        <div class="wow wow-white fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                            <div
                                ...
                                <div>
                                    <img style="width : 300px;height:200px"
                                    src="./assets/newImages/Exploration Drilling Rig/JCR-1500.png"
                                    alt="service_img" />
                                    <br>
                                    <br>
                                    <h4 class="fs_18 fw_normal c_dark4">JCU-1800</span></h4>
                                    <div class="link mb_75"><a href="product-27.php"
                                            class="ff_sec fw_bold tt_u fs_14 ls_1 c_light_dark">View more <i
                                                class="p_relative t_3 c_primary ml_10 fs_20 v_middle flaticon-right-arrow-2"></i></a>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4 ">
                        <div class="wow wow-white fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                            <div
                                ...
                                <div>
                                    <img style="width : 300px;height:200px"
                                    src="./assets/newImages/Exploration Drilling Rig/JCT-200.png"
                                    alt="service_img" />
                                    <br>
                                    <br>
                                    <h4 class="fs_18 fw_normal c_dark4">JCT-200</span></h4>
                                    <div class="link mb_75"><a href="product-7.php"
                                            class="ff_sec fw_bold tt_u fs_14 ls_1 c_light_dark">View more <i
                                                class="p_relative t_3 c_primary ml_10 fs_20 v_middle flaticon-right-arrow-2"></i></a>
                                    </div>
                                </div>
