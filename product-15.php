...
<head>
    <meta charset="utf-8">
    <title> Jia Drilling - JWC-10 TROLLEY MOUNTED DTHR WATER WELL DRILLING RIG</title>
    <!-- Stylesheets -->
    ...
    <div class="page-wrapper">
            ...
            <div class="auto-container">
                <div class="p_relative text-center">
                    <h1 class="c_light mb_10 fw_black fs_45 wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                        JWC-10 TROLLEY MOUNTED DTHR WATER WELL DRILLING RIG</h1>
                    <ul class="list-none fs_18 d-flex justify-content-center c_light wow fadeInLeft"
                        ...
                        <li>Products</li>
                        <li class="ml_10 mr_10">/</li>
                        <li>JWC-10 TROLLEY MOUNTED DTHR WATER WELL DRILLING RIG</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="pt_120 pb_90">
            <div class="auto-container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb_30"><img src="assets/newImages/DTH/JWC-10.jpg" alt=""></div>
                    </div>
                    <div class="col-lg-6 ps-lg-5">
                        ...
                        <h2 class="fw_black fs_30 mb_20">JWC-10 TROLLEY MOUNTED DTHR WATER WELL DRILLING RIG</h2>
                        <p class="mb_15 fs_16">The JWC-10 is a Trolley Mounted DTHR Water Well Drilling Rig especially designed for water well drilling up to 330 feet (100 Meters) for a drill diameter of 6 1/2" (165 mm). It is also capable of Rotary drilling with 4700 Kg pull-up force and 0 - 80 RPM or may be used with down the hole drills of 61/2" when equipped with a high-pressure air compressor. The same rig can also be utilized for exploration and micro-piling work.
    ...
    <table class="table table-striped table-bordered">
      ...
      <tbody>
        <tr>
          ...
          <td>Maximum 6<sup>1/2</sup>" <span>Ø</span> Bore Holes, 100 Meter (330 Foot) by using 2 <sup>1/2</sup>" Drill Rods<br>
              Odex Dia. - 5" - 300 foot depth
          </td>
        </tr>
        <tr>
          <td>PRIME MOVER</td>
          <td>Rig hydraulic system is powered from the deck engine - 75 Hp</td>
        </tr>
        <tr>
          <td>WORK METHOD</td>
        ...
        <tr>
          <td>MAST</td>
          <td>5" Channel Structure Mast, Maximum Capacity - 8 Tons, Height - 3.65 Meter (12 Foot), Rod Handling - 60", Centralized Opening - 7"</td>
        </tr>
        <tr>
          <td>PULL UP SPEED</td>
        ...
        <tr>
          ...
          <td>210 Kg/cm<sup>2</sup> (3000 psi)<br>
              Oil Tank - 300 Liters, Oil Filters - SC<sup>2</sup>-75 - 02 no.
          </td>
        </tr>
        <tr>
          <td>REEVING RATIO</td>
        ...
        <tr>
          ...
          <td>36 LPM, 40 Kg/cm<sup>2</sup> water pump driven by hydraulic motor</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            <span>•</span> Welding Machine<br>
            <span>•</span> Auxiliary Winch - 1 Ton<br>
            <span>•</span> Single Rod Changer<br>
            <span>•</span> Centrifugal Mud Pump - 3" x 3"
          </td>
        </tr>
      </tbody>
    </table>
