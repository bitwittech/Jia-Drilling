...
<head>
    <meta charset="utf-8">
    <title> Jia Drilling - JWC-15 TROLLEY MOUNTED DTHR WATER WELL DRILLING RIG</title>
    <!-- Stylesheets -->
    ...
    <div class="page-wrapper">
            ...
            <div class="auto-container">
                <div class="p_relative text-center">
                    <h1 class="c_light mb_10 fw_black fs_45 wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                        JWC-15 TROLLEY MOUNTED DTHR WATER WELL DRILLING RIG</h1>
                    <ul class="list-none fs_18 d-flex justify-content-center c_light wow fadeInLeft"
                        ...
                        <li>Products</li>
                        <li class="ml_10 mr_10">/</li>
                        <li>JWC-15 TROLLEY MOUNTED DTHR WATER WELL DRILLING RIG</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="pt_120 pb_90">
            <div class="auto-container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb_30"><img src="assets/newImages/DTH/JWC-15.jpg" alt=""></div>
                    </div>
                    <div class="col-lg-6 ps-lg-5">
                        ...
                        <h2 class="fw_black fs_30 mb_20">JWC-15 TROLLEY MOUNTED DTHR WATER WELL DRILLING RIG</h2>
                        <p class="mb_15 fs_16">The JWC-15 is a Trolley Mounted DTHR Water Well Drilling Rig especially
                            designed for water well drilling up to 490 feet (150 Meters) for a drill diameter of 6 ½"
                            (165 mm). It is also capable of Rotary drilling with 7 900 Kg pull up force and 0 − 100 RPM
                            or may be used with down the hole drills of 6 ½" when equipped with a high-pressure air
                            compressor. The same rig can also be utilized for exploration and micro-piling work.
...
<div class="container" >
        <table class="table table-bordered table-striped">
            <thead class="thead-dark">
                <tr>
                    <th colspan="2" style="font-size:16px; text-align: center;">TECHNICAL SPECIFICATIONS - JWC-15
                        TROLLEY MOUNTED DTHR WATER WELL DRILLING RIG</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td>DRILLING DEPTH</td>
                    <td>Maximum 6½" Ø Bore Holes, 150 Meter (490 Foot) by using 3 ½" Drill Rods<br>Odex Dia. − 5" − 300
                        foot depth</td>
                </tr>
                <tr>
                    <td>PRIME MOVER</td>
                    <td>Rig hydraulic system is powered from Deck Engine − 90 Hp</td>
                </tr>
                <tr>
                    <td>WORK METHOD</td>
                ...
                <tr>
                    <td>MAST</td>
                    <td>6" Channel Structure Mast, Height − 5.5 Meter (18 Foot), Rod Handling − 120", Centralized
                        Opening − 10⅝" (270 mm)</td>
                </tr>
                <tr>
                    <td>PULL UP SPEED</td>
                ...
                <tr>
                    ...
                    <td>5 400 Kg / 11 900 lbs</td>
                </tr>
                <tr>
                    <td>HYDRAULIC SYSTEM</td>
                    <td>210 Kg/cm² (3 000 psi)<br>Oil Tank − 350 Liters, Oil Filters - SC²-75 − 02 no.<br>Double super
                        system</td>
                </tr>
                <tr>
                    <td>REEVING RATIO</td>
                ...
                <tr>
                    <td>ROTARY HEAD</td>
                    <td>Maximum Torque 303 Kg-Meter (26 400 lbs-inch), OMT-315 Orbital Motor</td>
                </tr>
                <tr>
