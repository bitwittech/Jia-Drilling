...
<head>
    <meta charset="utf-8">
    <title> Jia Drilling - JBR-20 CRAWLER MOUNTED BLAST HOLE DRILLING RIG</title>
    <!-- Stylesheets -->
    ...
    <div class="page-wrapper">
            ...
            <div class="auto-container">
                <div class="p_relative text-center">
                    <h1 class="c_light mb_10 fw_black fs_45 wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                        JBR-20 CRAWLER MOUNTED BLAST HOLE DRILLING RIG</h1>
                    <ul class="list-none fs_18 d-flex justify-content-center c_light wow fadeInLeft"
                        ...
                        <li>Products</li>
                        <li class="ml_10 mr_10">/</li>
                        <li>JBR-20 CRAWLER MOUNTED BLAST HOLE DRILLING RIG</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="pt_120 pb_90">
            <div class="auto-container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb_30"><img src="assets/newImages/Blast Hole Drilling Rig/JBR-20.jpg" alt=""></div>
                    </div>
                    <div class="col-lg-6 ps-lg-5">
                        ...
                        <h2 class="fw_black fs_30 mb_20">JBR-20 CRAWLER MOUNTED BLAST HOLE DRILLING RIG</h2>
                        <p class="mb_15 fs_16">The JBR-20 is a Crawler Mounted Blast Hole Drilling Rig especially designed for single pass blast hole drilling up to 650 feet (200 Meters) for a drill diameter of 3½" to 4⅛" (89 mm to 105 mm). It is capable of rotary drilling with 9200 Kg pull-up force and 0 − 100 RPM or may be used with down-the-hole drills when equipped with a high-pressure air compressor.
                        </p>
    ...
    <thead>
      <tr>
        <th colspan="2" class="text-center" style="font-size: 16px;">
          TECHNICAL SPECIFICATIONS - JBR-20 CRAWLER MOUNTED BLAST HOLE DRILLING RIG
        </th>
      </tr>
    </thead>
    <tbody>
      <tr>
        ...
        <td>Maximum 4⅛" Þ Bore Holes, 200 Meter (650 Foot) by using 2" / 2 ½" Drill Rods<br>Odex Dia. − 5" to 8" − 350 foot depth</td>
      </tr>
      <tr>
        <td>PRIME MOVER</td>
        <td>Power required for the rig hydraulic is drawn from the crawler engine through the output PTO Shaft or from an extra deck engine.</td>
      </tr>
      <tr>
        <td>WORK METHOD</td>
        <td>DTH Drilling</td>
      ...
      <tr>
        <td>PULL UP FORCE</td>
        <td>9,200 Kg / 20,240 lbs</td>
      </tr>
      <tr>
        <td>PULL DOWN SPEED</td>
        <td>55 Meter / Min (181 Foot/Min)</td>
      </tr>
      <tr>
        <td>PULL DOWN FORCE</td>
        <td>6,318 Kg / 13,900 lbs</td>
      </tr>
      <tr>
        <td>HYDRAULIC SYSTEM</td>
        <td>210 Kg/cm² (3,000 psi)<br>Oil Tank − 350 Liters, Oil Filters - SC²-100 - 01 no., SC²-75 − 01 no.<br>Double super system</td>
      </tr>
      <tr>
        <td>REEVING RATIO</td>
        <td>1:3</td>
      ...
      <tr>
        <td>ROTARY HEAD</td>
        <td>Maximum Torque 303 Kg-Meter (26,400 lbs-inch)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>Hydraulic Cylinders for Oscillation, Boom Raise, Boom Swing, Mast Raise, Mast Swing and Break Out Operation.</td>
      </tr>
    </tbody>
  </table>
</div>
