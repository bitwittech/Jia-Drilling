...
<head>
    <meta charset="utf-8">
    <title> Jia Drilling - JWT-10 TRACTOR MOUNTED DTHR WATER WELL DRILLING RIG</title>
    <!-- Stylesheets -->
    ...
    <div class="page-wrapper">
            ...
            <div class="auto-container">
                <div class="p_relative text-center">
                    <h1 class="c_light mb_10 fw_black fs_45 wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                        JWT-10 TRACTOR MOUNTED DTHR WATER WELL DRILLING RIG</h1>
                    <ul class="list-none fs_18 d-flex justify-content-center c_light wow fadeInLeft"
                        ...
                        <li>Products</li>
                        <li class="ml_10 mr_10">/</li>
                        <li>JWT-10 TRACTOR MOUNTED DTHR WATER WELL DRILLING RIG</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="pt_120 pb_90">
            <div class="auto-container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb_30"><img src="assets/newImages/water well/JWT-10.png" alt=""></div>
                    </div>
                    <div class="col-lg-6 ps-lg-5">
                        ...
                        <h2 class="fw_black fs_30 mb_20">JWT-10 TRACTOR MOUNTED DTHR WATER WELL DRILLING RIG</h2>
                        <p class="mb_15 fs_16">The JWT − 10 is a Tractor Mounted Water Well Drilling Rig especially designed for DTH Water Well drilling up to 262 feet ( 80 Meters) for a drill diameter of 3½" to 4⅛" (89 mm to 105 mm). It is capable of rotary drilling with 2700 Kg pull-up force and 0 − 60 RPM or may be used with down-the-hole drills when equipped with a high-pressure air compressor. The same drilling rig can also be utilized for blast hole drilling and seismic shot hole drilling.
  ...
  <div class="table-responsive">
    <table class="table table-striped table-bordered">
      <thead class="thead-dark">
        <tr>
          <th colspan="2" class="text-center" style="font-size:16px;">
            TECHNICAL SPECIFICATIONS - JWT-10 TRACTOR MOUNTED DTHR WATER WELL
            DRILLING RIG
          </th>
        </tr>
      </thead>
      <tbody>
        ...
        <tr>
          <td>OTHER OPTIONS</td>
          <td>The same mast can be mounted on a small truck for easy approach of difficult site conditions. This can also be altered to drill horizontal bores up to 262 Foot.</td>
        </tr>
        <tr>
