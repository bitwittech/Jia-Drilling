...
<head>
    <meta charset="utf-8">
    <title> Jia Drilling - Construction & Augar Piling</title>
    <!-- Stylesheets -->
            ...
            <div class="auto-container">
                <div class="p_relative text-center">
                    ...
                    <ul class="list-none fs_18 d-flex justify-content-center c_light wow fadeInLeft"
                        ...
                        <li>Construction & Augar Piling</li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-lg-4 ">
                        <div class="wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                            <div
                                ...
                                <div>
                                    <img style="width : 300px;height:200px" src="./assets/newImages/Construction & Piling Rig/JAT-12.jpg" alt="service_img" />
                                    <br>
                                    <br>
                                    <h4 class="fs_18 fw_normal c_dark4">JAT-12</span></h4>
                    ...
                    <div class="col-lg-4 ">
                        <div class="wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                            <div
                                class="icon_box_1 icon_box_1_with_hover alt mb_30 p_relative d-flex p_35 pt_40 b_radius_6">
                                <div>
                                    <img style="width : 300px;height:200px" src="./assets/newImages/Construction & Piling Rig/JAT-24.png" alt="service_img" />
                                    <br>
                                    <br>
                                    <h4 class="fs_18 fw_normal c_dark4">JAT-24</span></h4>
                                    <div class="link mb_75"><a href="product-26.php"
                                            class="ff_sec fw_bold tt_u fs_14 ls_1 c_light_dark">View more <i
                                                class="p_relative t_3 c_primary ml_10 fs_20 v_middle flaticon-right-arrow-2"></i></a>
                                    </div>
                                </div>
