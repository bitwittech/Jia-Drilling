...
<head>
    <meta charset="utf-8">
    <title> Jia Drilling - Mining</title>
    <!-- Stylesheets -->
                            ...
                            <div
                                ...
                                <div>
                                    <img style="width : 300px;height:200px"
                                        src="./assets/newImages/Blast Hole Drilling Rig/JBT-10.png"
                                        alt="service_img" />
                                    <br>
                                    <br>
                                    <h4 class="fs_18 fw_normal c_dark4">JBT-10</span></h4>
                                    <div class="link mb_75"><a href="product-3.php"
                    ...
                    <div class="col-lg-4 ">
                        <div class="wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                            <div
                                ...
                                <div>
                                    <img style="width : 300px;height:200px"
                                        src="./assets/newImages/Blast Hole Drilling Rig/JSP-10.jpg"
                                        alt="service_img" />
                                    <br>
                                    <br>
                                    <h4 class="fs_18 fw_normal c_dark4">JSP-10</span></h4>
                                    <div class="link mb_75"><a href="product-2.php"
                                            class="ff_sec fw_bold tt_u fs_14 ls_1 c_light_dark">View more <i
                                                class="p_relative t_3 c_primary ml_10 fs_20 v_middle flaticon-right-arrow-2"></i></a>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4 ">
                        <div class="wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                            <div
                                ...
                                <div>
                                    <img style="width : 300px;height:200px"
                                        src="./assets/newImages/Blast Hole Drilling Rig/JST-10.png"
                                        alt="service_img" />
                                    <br>
                                    <br>
                                    <h4 class="fs_18 fw_normal c_dark4">JST-10</span></h4>
                                    <div class="link mb_75"><a href="product-1.php"
                                            class="ff_sec fw_bold tt_u fs_14 ls_1 c_light_dark">View more <i
                                                class="p_relative t_3 c_primary ml_10 fs_20 v_middle flaticon-right-arrow-2"></i></a>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4 ">
                        <div class="wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                            <div
                                ...
                                <div>
                                    <img style="width : 300px;height:200px"
                                        src="./assets/newImages/Blast Hole Drilling Rig/JBR-20.jpg"
                                        alt="service_img" />
                                    <br>
                                    <br>
                                    <h4 class="fs_18 fw_normal c_dark4">JBR-20</span></h4>
                                    <div class="link mb_75"><a href="product-4.php"
                                            class="ff_sec fw_bold tt_u fs_14 ls_1 c_light_dark">View more <i
                                                class="p_relative t_3 c_primary ml_10 fs_20 v_middle flaticon-right-arrow-2"></i></a>
                                    </div>
                                </div>
