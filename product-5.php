...
<head>
    <meta charset="utf-8">
    <title> Jia Drilling - JJAT-12 TRACTOR MOUNTED AUGER PILING RIG</title>
    <!-- Stylesheets -->
            ...
            <div class="auto-container">
                <div class="p_relative text-center">
                    <h1 class="c_light mb_10 fw_black fs_45 wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                        JAT-12 TRACTOR MOUNTED AUGER PILING RIG</h1>
                    <ul class="list-none fs_18 d-flex justify-content-center c_light wow fadeInLeft"
                        ...
                        <li>Products</li>
                        <li class="ml_10 mr_10">/</li>
                        <li>JAT-12 TRACTOR MOUNTED AUGER PILING RIG</li>
                    </ul>
                </div>
            </div>
        </section>
      ...
      <thead class="thead-dark">
        <tr>
          <th colspan="2" class="text-center" style="font-size:16px;">
            TECHNICAL SPECIFICATIONS - JAT-12 TRACTOR MOUNTED AUGER PILING RIG
          </th>
        </tr>
      </thead>
      <tbody>
        <tr>
          ...
          <td>Maximum 6½" Ø Bore Holes, 122 Meter (400 Foot) by using 2 ½" Drill Rods<br>
              Odex Dia. − 5" − 350 foot depth
          </td>
        </tr>
        <tr>
          <td>PRIME MOVER</td>
          <td>Rig hydraulic system is powered from the tractor engine through the output PTO Shaft. − Tractor Horse Power − 60 or above
          </td>
        </tr>
        <tr>
          <td>WORK METHOD</td>
          <td>Auger Drilling / Rotary Mud Drilling</td>
        </tr>
        <tr>
          <td>MAST</td>
        ...
        <tr>
          ...
          <td>210 Kg/cm² (3,000 psi)<br>
              Oil Tank − 300 Liters, Oil Filters - SC²-75 − 02 no.<br>
              Double super system
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>• Welding Machine<br>
              • Auxiliary Winch − 1 Ton<br>
              • Single Rod Changer<br>
              • Centrifugal Mud Pump − 3" x 3"
          </td>
        </tr>
      </tbody>
    </table>
